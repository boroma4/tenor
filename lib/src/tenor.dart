...
class Tenor {
  ...
  Future<TenorResponse> searchGIF(
    ...
    var url =
        'https://g.tenor.com/v1/search?key=$apiKey&q=$search&locale=$language';
    return await _privateRequestGif(
      url,
      limit: limit,
      contentFilter: contentFilter,
  ...
  Future<TenorResponse> randomGIF(
    ...
    var url =
        'https://g.tenor.com/v1/random?key=$apiKey&q=$search&locale=$language';
    return await _privateRequestGif(
      url,
      limit: limit,
      contentFilter: contentFilter,
  ...
  Future<List<String>> searchSuggestions(
    ...
    var url =
        'https://g.tenor.com/v1/search_suggestions?key=$apiKey&q=$search&locale=$language';
  ...
  Future<List<String>> autoComplete(
    ...
    var url =
        'https://g.tenor.com/v1/autocomplete?key=$apiKey&q=$search&locale=$language';
    return await _requestSearchSuggestions(
      url,
      limit: limit,
    );
